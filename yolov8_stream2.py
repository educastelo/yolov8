...
points_polygon = [[[436, 409], [1051, 441], [1082, 716], [6, 714], [12, 451], [436, 409]]]
stream = 'rtmp://rtmp03.datavisiooh.com:1935/cartel_DN5502A'
...
while True:
    ...
    # print(f"[INFO] classification time stream 2: {tempo_total} ms")
